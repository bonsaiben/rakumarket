...
describe Rakumarket::ItemList do
  ...
  describe ".parse" do
    ...
    it "parses item_count" do
      @item_list.total_item_count.should eq(3507)
    end

    it "parses page_count" do
    ...
    describe "items" do
      ...
      describe "item" do
        ...
        it "parses rank" do
          @item.rank.should eq('1')
        end

        it "parses catchphrase" do
        ...
        it "parses start_time as nil if blank" do
        ...
        it "parses end_time as nil if blank" do
          @response = {"Items" => {"Item" => [{"endTime" => ""}]}}
          @item = Rakumarket::ItemList.parse(@response).items.first
          @item.end_time.should be_nil
        end

        it "parses review_count" do
          @item.review_count.should eq("3")
        end

        it "parses review_average" do
          @item.review_average.should eq("4")
        end

        it "parses point_multiplication_factor" do
          @item.point_multiplication_factor.should eq("2")
        end

        it "parses point_multiplication_start_time" do
          @item.point_multiplication_start_time.should be_a(Time)
        end

        it "parses point_multiplication_end_time" do
  ...
  describe ".parse" do
    context "root" do
      before do
        ...
        @genre = Rakumarket::GenreFamily.parse(@response)
      end
